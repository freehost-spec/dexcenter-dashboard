...
let ConnectionTableComponent = class ConnectionTableComponent {
    ...
    ngOnInit() {
        this.connectiondata = [
            { id: 2, systemname: 'DB', parentname: 'DXS', connectionnumber: '10', failconnection: '0', utilisation: '100%', state: 'Working' },
            { id: 1, systemname: 'DXS', parentname: 'DXS', connectionnumber: '10', failconnection: '0', utilisation: '40%', state: 'Working' },
